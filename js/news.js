...
const displayNews = newses => {
    ...
    foundMenu.innerHTML = `<h2 class="text-xl w-11/12 mx-auto border-0 bg-base-100	  divide-slate-300 font-semibold rounded-md p-3">${newses.length} items found for this category.</h2>`
